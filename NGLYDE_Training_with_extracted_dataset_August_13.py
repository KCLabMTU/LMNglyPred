...
for i in range(len(a)):
    ...
    y_train_positive = [1]*2023
    y_train_negative = [0]*(3024-2023)
    ...
    model.save("Saturday_LMNnglydePred_new_extracted_dataset"+str(seed)+".h5")
    print("**********************************************************")
    print("\n")
    print("Seed:   ",seed)
    print("\n")
    print("Saturday_LMNnglydePred_new_extracted_dataset"+str(seed)+".h5")
    print("\n")
    print("**********************************************************")  
